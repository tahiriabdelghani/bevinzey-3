    ...
    <section>
          ...
          <div className="max-w-3xl  mx-auto text-center pb-12 md:pb-16">
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <Link
                  className="btn py-4 cursor-pointer text-white border-2 rounded-full  bg-orange-600 hover:bg-orange-700 w-full mb-4 sm:w-auto sm:mb-0"
                  to="/pricing"
                >
                  Get started{" "}
              ...
              <div
                ...
                data-aos-delay="600"
              >
                <a className="btn py-4 cursor-pointer  text-orange-500 bg-white border-2 border-orange-500 rounded-full  w-full sm:w-auto sm:ml-4">
                  Learn more{" "}
      ...
      <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
        <div className="relative  flex justify-center items-center">
          {/* <R url='https://www.youtube.com/watch?v=V2SUw8hl0x0' /> */}
          {videoModalOpen ? <iframe className='h-screen w-full' src="https://www.youtube.com/embed/V2SUw8hl0x0"
            title="YouTube video player"
            frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> : <></>}
          {/* <iframe className="absolute w-full h-full" src="https://www.youtube.com/watch?v=V2SUw8hl0x0" title="Video" allowFullScreen></iframe> */}
        </div>
      </Modal>
    </section>
  );
