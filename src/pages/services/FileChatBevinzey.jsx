...
function FileChatBevinzey() {
  ...
  const sendMessage = (msg) => {
    if (!loading) {
      if (selectedChat === null) {
        ...
        axios
          .post(
            "https://api.bevinzey.com/ai-services/gpt/ChatBevinzey",
            {
              userId: user.id,
              chatId: selectedChat,
              prompt: msg,
  ...
  const createNewChatAndSend = (msg) => {
    axios
      .post(
        "https://api.bevinzey.com/ai-services/create/chat",
        {
          userId: user.id,
        }
      )
  ...
  const getChats = () => {
    axios
      .get(
        "https://api.bevinzey.com/ai-services/user/chats/" +
        user.id
      )
      .then((res) => {
        setChats(res.data);
  ...
  const clearChat = () => {
    axios
      .get(
        "https://api.bevinzey.com/ai-services/delete/chats/user/" +
        user.id
      )
      .then((res) => {
        getChats();
          ...
          <div className="relative flex h-full">
            ...
            >
              ...
              <div className="big-div">
                {
                  messages.length > 0 ? <MessagesBody messages={messages} loading={loading} /> : "no msgs"
                }
              </div>
