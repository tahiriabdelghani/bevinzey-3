        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                ...
                <div className="md:flex md:items-center md:justify-between mt-3">
                  ...
                  <div className="flex justify-center mt-4 md:mt-0" data-aos="fade-up" data-aos-delay="600">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <Link to="#" className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-orange-600 hover:bg-orange-700 transition duration-150 ease-in-out">Product</Link>
                      </li>
                      <li className="m-1">
              ...
              <footer>
                <div className="md:flex md:items-center md:justify-between text-center md:text-left">
                  ...
                  <ul className="inline-flex mt-4 md:ml-4 md:mb-0">
                    <li>
                      <Link to="#" className="flex justify-center items-center text-orange-600 bg-gray-800 hover:text-gray-100 hover:bg-orange-600 rounded-full transition duration-150 ease-in-out">
          ...
          <aside className="mt-20">
            <div className="max-w-sm mx-auto md:max-w-none">
              ...
              {/* Section title */}
              <h4 className="h4 py-6 mb-10 border-t border-b border-gray-700">More from Bevinzey</h4>
