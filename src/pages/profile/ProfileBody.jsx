...
function ProfileBody() {
  ...
  return (
    <div className="min-w-[80%] mx-auto">
        ...
        <ul className="flex flex-wrap -m-1">
          <li className="mr-8 mt-2">
            <button
              ...
              className={`inline-flex items-center border-[2px] border-slate-800 justify-center text-sm font-semibold leading-5 rounded-full px-8 py-2 border shadow-sm duration-150 ease-in-out uppercase ${
                selectedTab === 0
      ...
      <div
        className={
          "bg-[#F7FAFC] rounded-xl grow flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out translate-x-0"
        }
      >
        {/* Profile background */}
        <div className="relative h-44 overflow-hidden">
          <div className="bg-slate-800 min-w-full h-full rounded-xl">
            <div
              className="absolute left-12 bottom-0 -ml-20 hidden lg:block pointer-events-none"
              aria-hidden="true"
              data-aos="fade-up"
              data-aos-delay="400"
            >
            ...
            <div
              className="absolute right-0 top-0 -ml-20 hidden lg:block pointer-events-none"
              aria-hidden="true"
              data-aos="fade-up"
              data-aos-delay="400"
            >
        ...
        <div className="relative px-4 sm:px-6 pb-8">
          ...
          <header className="text-center sm:text-left mb-6">
            {/* Name */}
            <div className="inline-flex text-slate-800 items-start mb-2 md:hidden">
              {userData && (
                <div className="">
                  <h1 className="text-2xl  font-bold">
                    {userData?.first_name + " " + userData?.last_name}
