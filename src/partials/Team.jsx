        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="sm:flex sm:flex-wrap sm:justify-center -my-4 sm:-my-8 sm:-mx-3" data-aos-id-team>
            ...
            <div className="text-lg text-gray-400">
              ...
              <blockquote className="italic pl-4 border-l-2 border-gray-200 mb-8">Dr. Michael Danquah is a true innovator in the world of education and technology. As a drug delivery expert, chemical engineer, and  Professor who Chairs the Department of Pharmaceutical Sciences at Chicago State University College of Pharmacy, Dr. Danquah has dedicated his career to improving outcomes for students and educators alike </blockquote>
