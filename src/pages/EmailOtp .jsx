...
import { setCode, switchLoginStatus } from '../redux/auth';
...
function EmailOtp() {
  ...
  const onSubmit = async (e) => {
    ...
    if (parseInt(otpCode) !== parseInt(code)) {
      ...
      dispatch(setMessage("Please enter a valid otp code"))
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1 mb-4">Verify Email</h1>
                <p className="text-xl text-gray-400">Please check your email, then enter the received code</p>
              </div>
                ...
                <form onSubmit={onSubmit} >
                  <div className="flex flex-wrap  -mx-3 mb-4">
                    <div className="w-full mb-4 px-3">
                      <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="email">Otp code</label>
                      <input type="number" onChange={handelChange} value={otpCode} name="otpCode"
                        className="form-input w-full text-slate-700"
                        placeholder="Enter received code in your email "
                        required />
                    </div>
